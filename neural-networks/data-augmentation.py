...
FILE_PATH = '/Users/fpj/Development/python/ml-with-python/neural-networks/data/'
FILE_NORMAL = 'normal.pt'
FILE_ROTATED = 'rotated_data.pt'
...
file_normal = os.path.join(FILE_PATH, FILE_NORMAL)
...
#
checkpoint_normal = torch.load(os.path.join(FILE_PATH, FILE_NORMAL))
...
# Location to save data
file_rotated = os.path.join(FILE_PATH, FILE_ROTATED)
...
#
# Analyze results
checkpoint_rotated= torch.load(os.path.join(FILE_PATH, FILE_ROTATED))
